...
const Feature89 = () => {
  return (
    <section className="overflow-hidden py-32 mx-8">
      <div className=" relative">
        ...
        <div className="relative flex justify-between gap-16">
          ...
          <div className="w-full max-w-xl shrink-0 justify-between">
            <p className="font-mono text-xs text-muted-foreground">
              We are Media-X-Infinity
            </p>
            <h2 className="mb-3 mt-6 text-6xl font-medium lg:text-6xl">
              Building websites is a craft!
            </h2>
